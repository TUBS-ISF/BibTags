...
if __name__ == '__main__':
    with open(get_path("../test/config_check_integrity.yaml"), "r") as stream:
        try:
    ...
    with open(get_path("../test/config_field_types.yaml"), "r") as stream:
        try:
            fields = yaml.safe_load(stream)
        except yaml.YAMLError as exc:
            print(exc)

    with open(get_path("../test/config_string_fields.yaml"), "r") as stream:
        try:
